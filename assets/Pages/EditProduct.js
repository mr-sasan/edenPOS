...
class EditProductPage extends Component {
  ...
  componentWillMount () {
    ...
    CatelogData.append('ProductId', this.props.ProductId);

    fetch( CONFIG.SERVER_URL + "ReadProductDataForUpdate.php", {
      method: 'POST',
      body: CatelogData
    }).then((response) => response.json())
    .then((responseJson) => {
      if(responseJson.ProductColored == true){
        this.setState({
          ProductName: responseJson.name,
          ProductPrice: responseJson.price + '',
          ProductDescription: responseJson.description,
          ProductColored: responseJson.ProductColored,
          ProductWomenType: responseJson.ProductWomenType,
          ProductMenType: responseJson.ProductMenType,
          ProductKidType: responseJson.ProductKidType,
          ColorsObject: responseJson.ColorsObject,
          Loaded: true,
        });
      }else{
        this.setState({
          ...
          ProductDescription: responseJson.description,
          ProductColored: responseJson.ProductColored,
          PictureURI: responseJson.PictureURI,
          ProductWomenType: responseJson.ProductWomenType,
          ProductMenType: responseJson.ProductMenType,
          ProductKidType: responseJson.ProductKidType,
          Loaded: true,
      ...
      if(res != 'null'){
        ...
        for(var i=0; i < this.state.ColorsObject.length; i++){
          if(i == EditedColorData.ColorId){
            ...
            NewColorsObject.push({
              id: this.state.ColorsObject[i].id,
  ...
  SubmitProduct(){
    if(this.verifyDataEntry() == true){
      ...
      ProductData.append('ProductPrice', this.state.ProductPrice);
      ...
      ProductData.append('ProductDescription', this.state.ProductDescription);
      if(this.state.ProductColored == true){
        var ColorsObjectData = [];
        for(var i=0; i < this.state.ColorsObject.length; i++){
          var ColorSizesData = [];
          for(var f=0; f < this.state.ColorsObject[i].ColorImages.length; f++){
            if(this.state.ColorsObject[i].ColorImages[f].uri != "" && this.state.ColorsObject[i].ColorImages[f].image_url == ""){
              if(this.state.ColorsObject[i].ColorImages[f].id != 0){
                ProductData.append('ProductColor'+i+'ImageId'+f, this.state.ColorsObject[i].ColorImages[f].id);
              }
            ...
            }else if(this.state.ColorsObject[i].ColorImages[f].uri == "" && this.state.ColorsObject[i].ColorImages[f].image_url != ""){
              ProductData.append('ProductColor'+i+'ImageId'+f, this.state.ColorsObject[i].ColorImages[f].id);
            }
          }
          for(var f=0; f < this.state.ColorsObject[i].ColorSizes.length; f++){
            ColorSizesData.push({
              id: this.state.ColorsObject[i].ColorSizes[f].id,
        ...
        if(this.state.PictureURI[0].uri != "" && this.state.PictureURI[0].image_url == ""){
        ...
        }else if(this.state.PictureURI[0].uri == "" && this.state.PictureURI[0].image_url != ""){
          ProductData.append('ProductImageId1', this.state.PictureURI[0].id);
        }
        if(this.state.PictureURI[1].uri != "" && this.state.PictureURI[1].image_url == ""){
        ...
        }else if(this.state.PictureURI[1].uri == "" && this.state.PictureURI[1].image_url != ""){
          ProductData.append('ProductImageId2', this.state.PictureURI[1].id);
        }
        if(this.state.PictureURI[2].uri != "" && this.state.PictureURI[2].image_url == ""){
        ...
        }else if(this.state.PictureURI[2].uri == "" && this.state.PictureURI[2].image_url != ""){
          ProductData.append('ProductImageId3', this.state.PictureURI[2].id);
        }
      }
      fetch( CONFIG.SERVER_URL + "UpdateProduct.php", {
        method: 'POST',
        headers: {
        ...
        Object.entries(value.ColorImages).map(([key2, value2]) => {
          if(value2.uri != ""){
            ColorImagesObject.push(
              <Image style={[styles.FourAngleBox_32dp, styles.marginLeftt_4, styles.borderRadius_4]} key={'ColorURI'+key+'Image'+key2} source={{uri: value2.uri}} />
            );
          }
          if(value2.image_url != ""){
            ColorImagesObject.push(
              <Image style={[styles.FourAngleBox_32dp, styles.marginLeftt_4, styles.borderRadius_4]} key={'ColorURL'+key+'Image'+key2} source={{uri: value2.image_url}} />
            );
          }
        });
        ColorsObject.push(
        ...
        <ScrollView
          ...
          <View style={[styles.FullWideContentContainer, styles.paddingHorizontal_16, styles.row_reverse]}>
            ...
            <View style={[styles.ProductNoImageTemplate, styles.alignItems_center, styles.justifyContent_center, styles.borderRadius_8, styles.BackgroundColor_LightGray]}>
              ...
              <View style={styles.ImageBottomIconsType3}>
                <TouchableHighlight activeOpacity={1} underlayColor='transparent' onPress={() => this.DeleteProductImage(0)} style={[styles.NewSectionOrPartType2, styles.position_absolute, styles.Backcolor_White]}>
            ...
            <View style={[styles.ProductNoImageTemplate, styles.alignItems_center, styles.justifyContent_center, styles.borderRadius_8, styles.BackgroundColor_LightGray]}>
              ...
              <View style={styles.ImageBottomIconsType3}>
                <TouchableHighlight activeOpacity={1} underlayColor='transparent' onPress={() => this.DeleteProductImage(0)} style={[styles.ButtonCircle_56, styles.position_absolute, styles.Backcolor_White, styles.ButtonCircle_56_Elevation]}>
                  <Image style={styles.Icon12x12} source={require('../Icons/trash-black.png')} />
                </TouchableHighlight>
              </View>
            </View>}
            ...
            <View style={[styles.ProductNoImageTemplate, styles.alignItems_center, styles.justifyContent_center, styles.borderRadius_8, styles.BackgroundColor_LightGray]}>
              ...
              <View style={styles.ImageBottomIconsType3}>
                <TouchableHighlight activeOpacity={1} underlayColor='transparent' onPress={() => this.DeleteProductImage(1)} style={[styles.NewSectionOrPartType2, styles.position_absolute, styles.BackgroundColor_LightRed]}>
                  <Image style={styles.Icon12x12} source={require('../Icons/trash-black.png')} />
                </TouchableHighlight>
              </View>
            </View>}
            ...
            <View style={[styles.ProductNoImageTemplate, styles.alignItems_center, styles.justifyContent_center, styles.borderRadius_8, styles.BackgroundColor_LightGray]}>
              ...
              <View style={styles.ImageBottomIconsType3}>
                <TouchableHighlight activeOpacity={1} underlayColor='transparent' onPress={() => this.DeleteProductImage(2)} style={[styles.NewSectionOrPartType2, styles.position_absolute, styles.BackgroundColor_LightRed]}>
                  <Image style={styles.Icon12x12} source={require('../Icons/trash-black.png')} />
                </TouchableHighlight>
              </View>
            </View>}
          ...
          <View style={styles.NavBarView}>
            <View style={styles.NavBarRightView}>
              <Text style={styles.NavBarTextLarge}>ویرایش محصول</Text>
            </View>
            <View style={styles.NavBarLeftView}>
              ...
              {this.state.AddingProductProcess == false &&
                <TouchableHighlight activeOpacity={1} style={[styles.ButtonSmall_64, styles.Backcolor_blue]} underlayColor='transparent' onPress={() => this.SubmitProduct()}>
                  <Text style={[styles.Text_26_B, styles.Color_white]}>انجام شد</Text>
                </TouchableHighlight>}
