...
class ProductPage extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      ColorsAndSizes: [{
        ...
        Images:[{
          image_url: require('../Images/adidas_prod_StanBlack_1.jpg'),
        },{
          image_url: require('../Images/adidas_prod_StanBlack_2.jpg'),
        },{
          image_url: require('../Images/adidas_prod_StanBlack_3.jpg'),
        }],
      },{
        id:1,
        title:'سبز',
        ...
        Images:[{
          image_url: require('../Images/adidas_prod_Stan_Green_1.jpg'),
        },{
          image_url: require('../Images/adidas_prod_Stan_Green_2.jpg'),
        },{
          image_url: require('../Images/adidas_prod_Stan_Green_3.jpg'),
        }],
      },{
        id:2,
        title:'قرمز',
  ...
  componentWillMount() {
    fetch("http://192.168.43.31/EdenPOS/Product.json")
        .then((response) => response.json())
        .then((responseData) => {
            this.setState({ProductJsonData: responseData});
        })
        .done();
        Alert.alert('ss','2');
  }
    ...
    for(let i=0;i<this.state.ColorsAndSizes.length;i++){
      if(this.state.ColorsAndSizes[i].is_active == true){
        for(let f=0;f<this.state.ColorsAndSizes[i].Images.length;f++){
          ImagesObject.push(
            <Image key={'image-'+f} style={styles.ProductImage} source={this.state.ColorsAndSizes[i].Images[f].image_url} />
          );
        }
    ...
    return (
      <View style={styles.container}>
        ...
        <View style={styles.MainCategoryContent}>
          ...
          <View style={[styles.UserLocationContainer, styles.marginTop_8]}>
            <View style={styles.UserLocation}>
              <TouchableHighlight activeOpacity={1} underlayColor='transparent' onPress={() => base.gotopage(this.props.navigator, 100,'null')}>
                <Text style={styles.UserLocationText}>آدیداس</Text>
              </TouchableHighlight>
              <Image style={styles.arrow_front} source={require('../Icons/arrow-front-lightgray.png')} />
              <TouchableHighlight activeOpacity={1} underlayColor='transparent' onPress={() => base.gotopage(this.props.navigator, 101,'null')}>
                <Text style={styles.UserLocationText}>کفش ها</Text>
              </TouchableHighlight>
              <Image style={styles.arrow_front} source={require('../Icons/arrow-front-lightgray.png')} />
              <Text style={styles.UnLinkTextColorType2}>آدیداس استن اسمیت</Text>
            </View>
          </View>
